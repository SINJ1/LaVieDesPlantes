...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'La_vie_des_plantes_999507a909753f589416_20240531143357_archive.zip';
        const ARCHIVE_SIZE       = '129332527';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '999507a-31143357';
        const SECONDARY_PACKAGE_HASH = '2416cd0-31143357';
        const VERSION            = '1.5.9';
